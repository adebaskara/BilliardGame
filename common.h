...
const int table_width = 730;
const int table_height = 360;
const int table_xinit = 35;
const int table_yinit = 100;
const int powerbar_xinit = 25;
const int powerbar_yinit = 500;
